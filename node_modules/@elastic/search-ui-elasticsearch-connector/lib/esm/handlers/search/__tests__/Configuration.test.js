import buildConfiguration, { buildBaseFilters, getResultFields } from "../Configuration";
jest.mock("@searchkit/sdk");
import { MultiMatchQuery, RefinementSelectFacet, MultiQueryOptionsFacet, GeoDistanceOptionsFacet, Filter } from "@searchkit/sdk";
