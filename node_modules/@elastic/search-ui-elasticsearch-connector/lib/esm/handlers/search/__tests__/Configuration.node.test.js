...
describe("Search - Configuration within node context", () => {
    describe("buildConfiguration", () => {
        ...
        it("builds configuration", () => {
            ...
            expect(configuration.connectionOptions.headers["x-elastic-client-meta"]).toEqual(`ent=${LIB_VERSION}-es-connector,js=${nodeVersion},t=${LIB_VERSION}-es-connector,ft=universal`);
        });
    });
});
